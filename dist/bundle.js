...
var _dashBoard = __webpack_require__(125);
...
var store = (0, _redux.createStore)(_reducer2.default, (0, _developmentOnly.composeWithDevTools)(_redux.applyMiddleware.apply(undefined, (0, _toConsumableArray3.default)(_middleware2.default))));
...
__webpack_require__(71)(IteratorPrototype, __webpack_require__(101)('iterator'), function () { return this; });
...
exports.composeWithDevTools = (
  "none" !== 'production' && typeof window !== 'undefined' &&
...
var _revenues = __webpack_require__(113);
...
var reducers = (0, _redux.combineReducers)({ revenues: _revenues2.default, dashBoard: _dashBoard2.default });
...
var saveTotalRevenues = function saveTotalRevenues(state, _ref) {
  var totalRevenues = _ref.totalRevenues;
  return (0, _extends3.default)({}, state, { totalRevenues: totalRevenues });
};

var saveServiceRevenues = function saveServiceRevenues(state, _ref2) {
  var serviceTypeRevenues = _ref2.serviceTypeRevenues;

  var serviceTypeObj = { type: 'Service' };
  for (var key in serviceTypeRevenues) {
    serviceTypeObj[key] = serviceTypeRevenues[key].Transactions;
  };
  var keys = Object.keys(serviceTypeRevenues);
  var serviceType = keys.map(function (item) {
    return (0, _extends3.default)({ ServiceType: item }, serviceTypeRevenues[item]);
  });
  return (0, _extends3.default)({}, state, { serviceTypeRevenues: serviceType, Transactions: [].concat((0, _toConsumableArray3.default)(state.Transactions), [serviceTypeObj]) });
};

var saveChannelRevenues = function saveChannelRevenues(state, _ref3) {
  var channelTypeRevenues = _ref3.channelTypeRevenues;

  var channelTypeObj = { type: 'Channel' };
  for (var key in channelTypeRevenues) {
    channelTypeObj[key] = channelTypeRevenues[key].Transactions;
  };
  var keys = Object.keys(channelTypeRevenues);
  var channelType = keys.map(function (item) {
    return (0, _extends3.default)({ ChannelType: item }, channelTypeRevenues[item]);
  });
  return (0, _extends3.default)({}, state, { channelTypeRevenues: channelType, Transactions: [].concat((0, _toConsumableArray3.default)(state.Transactions), [channelTypeObj]) });
};

var saveCityRevenues = function saveCityRevenues(state, _ref4) {
  var cityRevenues = _ref4.cityRevenues;

  var revenues = { city: "cities", children: [] };
  for (var i in cityRevenues) {
    revenues.children.push({ city: 'city' + i, children: [{ city: i, grossRevenue: cityRevenues[i] }] });
  };
  return (0, _extends3.default)({}, state, { cityRevenues: revenues });
};

var saveDateObj = function saveDateObj(state, _ref5) {
  var dateObj = _ref5.dateObj;
  return (0, _extends3.default)({}, state, { dateObj: dateObj });
};
...
var showHideLoader = function showHideLoader(state, _ref6, type) {
  var showLoader = _ref6.showLoader,
      showServiceTypeLoader = _ref6.showServiceTypeLoader,
      showChannelTypeLoader = _ref6.showChannelTypeLoader,
      showCityLoader = _ref6.showCityLoader;

  if (type === 'dashboard') {
    return (0, _extends3.default)({}, state, { showLoader: showLoader });
  } else if (type === 'service') {
    return (0, _extends3.default)({}, state, { showServiceTypeLoader: showServiceTypeLoader });
  } else if (type === 'channel') {
    return (0, _extends3.default)({}, state, { showChannelTypeLoader: showChannelTypeLoader });
  } else if (type === 'city') {
    return (0, _extends3.default)({}, state, { showCityLoader: showCityLoader });
  }
  return (0, _extends3.default)({}, state);
};

var revenues = function revenues() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  switch (action.type) {
    case _constants.SAVE_SALES_TOTAL_REVENUES:
      return saveTotalRevenues(state, action);
    case _constants.SAVE_SERVICE_BASED_REVENUES:
      return saveServiceRevenues(state, action);
    case _constants.SAVE_CHANNEL_BASED_REVENUES:
      return saveChannelRevenues(state, action);
    case _constants.SAVE_CITY_BASED_REVENUES:
      return saveCityRevenues(state, action);
    case _constants.ENABLE_DISABLE_LOADER:
      return showHideLoader(state, action, 'dashboard');
    case _constants.ENABLE_DISABLE_SERVICE_TYPE_LOADER:
      return showHideLoader(state, action, 'service');
    case _constants.ENABLE_DISABLE_CHANNEL_TYPE_LOADER:
      return showHideLoader(state, action, 'channel');
    case _constants.ENABLE_DISABLE_CITY_LOADER:
      return showHideLoader(state, action, 'city');
    case _constants.SAVE_DATE_OBJECT:
      return saveDateObj(state, action);
    case _constants.CLEAR_TRANSACTIONS:
...
var SAVE_SALES_TOTAL_REVENUES = exports.SAVE_SALES_TOTAL_REVENUES = 'SAVE_SALES_TOTAL_REVENUES';
var SAVE_SERVICE_BASED_REVENUES = exports.SAVE_SERVICE_BASED_REVENUES = 'SAVE_SERVICE_BASED_REVENUES';
var SAVE_CHANNEL_BASED_REVENUES = exports.SAVE_CHANNEL_BASED_REVENUES = 'SAVE_CHANNEL_BASED_REVENUES';
var SAVE_CITY_BASED_REVENUES = exports.SAVE_CITY_BASED_REVENUES = 'SAVE_CITY_BASED_REVENUES';
var ENABLE_DISABLE_LOADER = exports.ENABLE_DISABLE_LOADER = 'ENABLE_DISABLE_LOADER';
var ENABLE_DISABLE_SERVICE_TYPE_LOADER = exports.ENABLE_DISABLE_SERVICE_TYPE_LOADER = 'ENABLE_DISABLE_SERVICE_TYPE_LOADER';
var ENABLE_DISABLE_CHANNEL_TYPE_LOADER = exports.ENABLE_DISABLE_CHANNEL_TYPE_LOADER = 'ENABLE_DISABLE_CHANNEL_TYPE_LOADER';
var ENABLE_DISABLE_CITY_LOADER = exports.ENABLE_DISABLE_CITY_LOADER = 'ENABLE_DISABLE_CITY_LOADER';
var SAVE_DATE_OBJECT = exports.SAVE_DATE_OBJECT = 'SAVE_DATE_OBJECT';
var CLEAR_DATE_OBJECT = exports.CLEAR_DATE_OBJECT = 'CLEAR_DATE_OBJECT';
var CLEAR_TRANSACTIONS = exports.CLEAR_TRANSACTIONS = 'CLEAR_TRANSACTIONS';
var ENABLE_DISABLE_SLIDE_MENU = exports.ENABLE_DISABLE_SLIDE_MENU = 'ENABLE_DISABLE_SLIDE_MENU';
...
var toggleSlideMenu = function toggleSlideMenu(state) {
  return (0, _extends3.default)({}, state, { menuOpen: !state.menuOpen });
};
var setErrorMessage = function setErrorMessage(state, _ref) {
  var value = _ref.value;
  return (0, _extends3.default)({}, state, { apiError: value });
};
...
var dashBoard = function dashBoard() {
  ...
  switch (action.type) {
    case _constants.ENABLE_DISABLE_SLIDE_MENU:
